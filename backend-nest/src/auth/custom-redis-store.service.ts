...
import { MemoryStore as BaseMemoryStore, Store, Session } from 'express-session';
...
export class CustomRedisStore extends Store implements BaseMemoryStore {
    ...
    public get = (sid: string, callback: (err: any, session?: Session | null) => void) => {
    ...
    public all = (callback: (err: any, obj?: { [sid: string]: Session; } | null) => void) => {
    ...
    public touch = (sid: string, session: Session, callback?: (err?: any) => void) => {
